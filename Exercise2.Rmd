...
saratoga_split = initial_split(Houses_scale, prop = 0.8)
...
#create list of credit ratings
Credit_Rating = c('good', 'poor', 'terrible')

#discover probabilities for relative credit ratings
...
lm_devbest = lm(children ~ hotel + lead_time+ reserved_room_type + assigned_room_type + booking_changes + adults + required_car_parking_spaces + booking_changes + average_daily_rate + is_repeated_guest + arrival_date, data = dev_train)
...
My model did fairly poorly relative to the number of bookings made with children. Across all 20 folds, my model predicted that 4975 children would be present, while 402 actual children were present in the data. 
